// Provider是⽬前官⽅推荐的全局状态管理⼯具.
// 在使⽤Provider的时候，我们主要关⼼三个概念：
// • ChangeNotifier：真正数据（状态）存放的地⽅
// • ChangeNotifierProvider：Widget树中提供数据（状态）的地⽅，会在其中创建对应的ChangeNotifier
// • Consumer：Widget树中需要使⽤数据（状态）的地⽅
...
// 当数据发⽣变化时，就会通知依赖数据的Consumer重新调⽤builder⽅法来构建；
